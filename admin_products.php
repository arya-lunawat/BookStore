...
if(isset($_POST['add_products_btn'])){
  ...
  if(mysqli_num_rows($select_product_name)>0){
    ...
    $add_product_query = mysqli_query($conn, "INSERT INTO `products`(name, price, image, genre, author_name, ratings, description) VALUES ('$name', '$price', '$image', '$genre', '$author_name', '$ratings', '$description')") or die(mysqli_error($conn));
...
<section class="admin_add_products">
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <input type="text" name="genre" class="admin_input" placeholder="Enter Genre" required>
