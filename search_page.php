  ...
  <section class="products_cont">
    <div class="pro_box_cont">
      ...
      if (isset($_POST['submit'])) {
        ...
        $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE name LIKE '%{$search_item}%' or genre LIKE '%{$search_item}%' or author_name LIKE '%{$search_item}%'") or die('query failed');
