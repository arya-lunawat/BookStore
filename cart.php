...
<section class="shopping_cart">
  ...
  <div class="cart_box_cont">
    ...
    ?>
    <div class="cart_box">
      <a href="cart.php?delete=<?php echo $fetch_cart['id'];?>" class="fas fa-times" onclick="return confirm('Are you sure you want to delete this book from TBR list');"></a>
  ...
  <div class="cart_total">
    ...
    <div class="btns_cart">
    <a href="cart.php?delete_all" class="product_btn <?php echo ($grand_total > 1)?'':'disabled'; ?>" onclick="return confirm('Are you sure you want to delete all books from TBR list?');">Delete All from TBR</a>
